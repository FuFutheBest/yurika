...
export const skillsData: Skill[] = [
  ...
  },
  {
    ...
    name: "Neovim",
    description:
      "An extensible and highly customizable text editor based on Vim, suitable for efficient code editing.",
  ...
  // Other Skills
  {
    ...
    name: "Lua",
    description:
      "A lightweight, high-level scripting language designed for embedded use in applications.",
  ...
  },
  {
    ...
    name: "MATLAB",
    description:
      "A high-level programming language and environment for numerical computing, data analysis, and visualization.",
