...
export const ja: Translation = {
	...
	[Key.books]: "書籍",
	[Key.booksTitle]: "私の本棚",
	[Key.booksSubtitle]: "読書記録とコレクション",
	[Key.booksFilterAll]: "すべて",
	[Key.booksStatusReading]: "読書中",
	[Key.booksStatusCompleted]: "読了",
	[Key.booksStatusPlanned]: "積読",
	[Key.booksStatusOnHold]: "一時停止",
	[Key.booksStatusDropped]: "中断",
	[Key.booksYear]: "年",
	[Key.booksAuthor]: "著者",
	[Key.booksEmpty]: "書籍データなし",
	[Key.booksEmptyBangumi]: "Bangumi設定またはネットワーク接続を確認してください",
	[Key.booksEmptyLocal]: "src/data/books.tsに書籍データを追加してください",

	// ゲームページ
	[Key.games]: "ゲーム",
	[Key.gamesTitle]: "私のゲームリスト",
	[Key.gamesSubtitle]: "ゲームの旅を記録する",
	[Key.gamesFilterAll]: "すべて",
	[Key.gamesStatusPlaying]: "プレイ中",
	[Key.gamesStatusCompleted]: "クリア",
	[Key.gamesStatusPlanned]: "予定",
	[Key.gamesStatusOnHold]: "一時停止",
	[Key.gamesStatusDropped]: "中断",
	[Key.gamesYear]: "年",
	[Key.gamesDeveloper]: "開発",
	[Key.gamesPlatform]: "プラットフォーム",
	[Key.gamesEmpty]: "ゲームデータなし",
	[Key.gamesEmptyBangumi]: "Bangumi設定またはネットワーク接続を確認してください",
	[Key.gamesEmptyLocal]: "src/data/games.tsにゲームデータを追加してください",
