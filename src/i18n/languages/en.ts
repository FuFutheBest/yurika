...
export const en: Translation = {
	...
	[Key.booksSubtitle]: "Reading notes and collections",
	[Key.booksFilterAll]: "All",
	[Key.booksStatusReading]: "Reading",
	[Key.booksStatusCompleted]: "Completed",
	[Key.booksStatusPlanned]: "Planned",
	[Key.booksStatusOnHold]: "On Hold",
	[Key.booksStatusDropped]: "Dropped",
	[Key.booksYear]: "Year",
	[Key.booksAuthor]: "Author",
	[Key.booksEmpty]: "No books data",
	[Key.booksEmptyBangumi]: "Please check Bangumi configuration or network connection",
	[Key.booksEmptyLocal]: "Please add book data in src/data/books.ts",

	// Games Page
	[Key.games]: "Games",
	[Key.gamesTitle]: "My Game List",
	...
	[Key.gamesEmptyBangumi]: "Please check Bangumi configuration or network connection",
	[Key.gamesEmptyLocal]: "Please add game data in src/data/games.ts",
